execute @s[tag=stafftag,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 40000
execute @s[tag=stafftag,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 40000
...
execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag,scores={wbmtoggle=1}] {"rawtext":[{"text":"§¶§cRebirth §¶§b→ §6World Border §bhas been set to §240k §bby §d"},{"selector":"@s"}]}
