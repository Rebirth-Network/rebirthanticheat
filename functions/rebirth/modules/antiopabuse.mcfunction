...
execute @s[tag=stafftag,scores={aopamtoggle=1}] ~~~ tag @s remove tgmGodMode
execute @s[tag=stafftag,scores={aopamtoggle=1}] ~~~ scoreboard players reset @s tgmGodMode
execute @s[tag=stafftag,scores={aopamtoggle=1}] ~~~ tag @s remove spectate
execute @s[tag=stafftag,scores={aopamtoggle=1}] ~~~ scoreboard players reset @s vnsh
