...
scoreboard players operation @a eacmtoggle = eacmtoggledummy eacmtoggle
scoreboard players operation @a EACM = eacmtoggledummy EACM
scoreboard players operation @a afmtoggle = afmtoggledummy afmtoggle
scoreboard players operation @a AFM = afmtoggledummy AFM
scoreboard players operation @a apmtoggle = apmtoggledummy apmtoggle
scoreboard players operation @a APM = apmtoggledummy APM
