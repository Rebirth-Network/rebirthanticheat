#If player is staff
execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cRebirth → §d"},{"selector":"@s"},{"text":" §¶§bis staff and can't be frozen."}]}
...
execute @s[tag=!stafftag,scores={fzplr=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cRebirth → §d"},{"selector":"@s"},{"text":" §¶§bhas been §6frozen §bby a operator."}]}
