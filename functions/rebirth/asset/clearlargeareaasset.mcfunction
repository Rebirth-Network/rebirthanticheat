...
execute @p[scores={cleararealarge=2},tag=stafftag] ~-15 ~ ~15 summon armor_stand cleararealarge
execute @p[scores={cleararealarge=2},tag=stafftag] ~15 ~ ~-15 summon armor_stand cleararealarge
execute @p[scores={cleararealarge=2},tag=stafftag] ~~~ tellraw @a {"rawtext":[{"text":"§¶§cRebirth §b→ §d"},{"selector":"@s"},{"text":" §¶§bjust cleared a large area"}]}
...
execute @p[scores={cleararealarge=1},tag=stafftag] ~~~ tellraw @p[tag=!clearcheck] {"rawtext":[{"text":"§¶§cRebirth → This will fill all blocks within a 60 Squared radius with air!"}]}
execute @p[scores={cleararealarge=1},tag=stafftag] ~~~ tellraw @p[tag=!clearcheck] {"rawtext":[{"text":"§¶§cRebirth → This can't be undone! Execute command again if you're sure."}]}
execute @p[scores={cleararealarge=2},tag=stafftag] ~~~ tellraw @p[tag=!clearcheck] {"rawtext":[{"text":"§¶§cRebirth → The area has been cleared with air."}]}
