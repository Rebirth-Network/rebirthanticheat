...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={headen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§6No Enchanted Armor §c→ §bremoved helmet enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1,chesten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§6No Enchanted Armor §c→ §bremoved chestplate enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={legen=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§6No Enchanted Armor §c→ §bremoved legging enchants from §d"},{"selector":"@s"}]}
...
execute @s[scores={damtoggle=1}] ~~~ execute @s[scores={feeten=1}] ~~~ tellraw @a {"rawtext":[{"text":"§¶§6No Enchanted Armor §c→ §bremoved boot enchants from §d"},{"selector":"@s"}]}
