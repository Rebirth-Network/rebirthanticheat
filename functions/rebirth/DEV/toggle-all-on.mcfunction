...
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set damtoggledummy damtoggle 1
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players operation @a damtoggle = damtoggledummy damtoggle
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set damtoggledummy DAM 1
...
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set icmtoggledummy icmtoggle 1
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players operation @a icmtoggle = icmtoggledummy icmtoggle
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set icmtoggledummy ICM 1
...
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set mdmtoggledummy mdmtoggle 1
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players operation @a mdmtoggle = mdmtoggledummy mdmtoggle
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set mdmtoggledummy MDM 1
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set nemtoggledummy nemtoggle 1
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players operation @a nemtoggle = nemtoggledummy nemtoggle
execute @s[tag=stafftag,name=PointNetwork341] ~~~ scoreboard players set nemtoggledummy NEM 1
...
tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cRebirth §¶§b→ The §2Developer Light Switch §bhas been used by §d"},{"selector":"@s"},{"text":"§¶§b. All Modules have been §¶§2ENABLED"}]}
