...
execute @s[tag=stafftag,scores={EACM=1}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cRebirth §¶§b→ §6Extra Anti-CBE §bhas been toggled §2ON §bby §d"},{"selector":"@s"}]}
#turn off
...
execute @s[tag=stafftag,scores={EACM=2}] ~~~ tellraw @a[tag=stafftag] {"rawtext":[{"text":"§¶§cRebirth §¶§b→ §6Extra Anti-CBE §bhas been toggled §cOFF §bby §d"},{"selector":"@s"}]}
