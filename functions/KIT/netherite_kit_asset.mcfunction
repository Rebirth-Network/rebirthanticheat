...
execute @s[tag=stafftag] ~~~ tellraw @s {"rawtext":[{"text":"§¶§cRebirth §¶§b→ §bnetherite Kit has been applied to §d"},{"selector":"@s"}]}
execute @s[tag=stafftag}] ~~~ playsound note.pling @s ~ ~ ~
execute @s[tag=!stafftag] ~~~ playsound note.bass @s ~ ~ ~

replaceitem entity @s[tag=stafftag] slot.armor.head 0 netherite_helmet 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=stafftag] slot.armor.chest 0 netherite_chestplate 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=stafftag] slot.armor.legs 0 netherite_leggings 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=stafftag] slot.armor.feet 0 netherite_boots 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=stafftag] slot.weapon.offhand 0 totem_of_undying 1 0 {"minecraft:keep_on_death":{}}
replaceitem entity @s[tag=stafftag] slot.weapon.mainhand 0 netherite_sword 1 0 {"minecraft:keep_on_death":{}}
