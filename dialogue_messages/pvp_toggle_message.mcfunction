...
#toggle off
tellraw @s[scores={pvp=1}] {"rawtext":[{"text":"§¶§cRebirth → §6Player PVP §bhas been §cDISABLED §bby §d"},{"selector":"@s"}]}
...
#toggle on
tellraw @s[scores={pvp=2}] {"rawtext":[{"text":"§¶§cRebirth → §6Player PVP §bhas been §2ENABLED §bby §d"},{"selector":"@s"}]}
