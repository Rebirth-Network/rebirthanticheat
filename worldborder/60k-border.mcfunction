execute @s[tag=stafftag,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_X 60000
execute @s[tag=stafftag,scores={wbmtoggle=1}] ~~~ scoreboard players set BDXdummy Border_Coord_Z 60000
...
execute @s[tag=stafftag] ~~~ tellraw @a[tag=stafftag,scores={wbmtoggle=1}] {"rawtext":[{"text":"§¶§cRebirth §¶§b→ §6World Border §bhas been set to §260k §bby §d"},{"selector":"@s"}]}
